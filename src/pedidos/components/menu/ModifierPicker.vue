...
<template>
  ...
  >
    <div v-if="item" class="pedidos-modifier-modal__box" :style="dragStyle">
      <div
        class="pedidos-modifier-modal__handle-hitbox"
      ...
      <ul class="pedidos-modifier-modal__list">
        <li v-for="mod in item.modifiers" :key="mod.id">
          <label
            class="pedidos-modifier-modal__option"
            :class="{ 'pedidos-modifier-modal__option--selected': selected.has(mod.id) }"
          >
...
.pedidos-modifier-modal__handle-hitbox {
  display: flex;
  justify-content: center;
...
.pedidos-modifier-modal__handle-hitbox:active {
  cursor: grabbing;
}
...
.pedidos-modifier-modal__close:active {
  transform: scale(0.9);
}
...
.pedidos-modifier-modal__option--selected {
